...
\input{Songs/Bolaget.tex}
\input{Songs/Detvarivårungdomsfagrastevår.tex}
\input{Songs/Portosvisa.tex}
\input{Songs/Vitvecka.tex}
\input{Songs/Drucknasällskap.tex}
\input{Songs/Jagskafesta.tex}
\input{Songs/Drinkingsong.tex}
\input{Songs/StudenternasFyllenatt.tex}
\input{Songs/Störthärligtfull.tex}
\input{Songs/Gåpåfest.tex}
\input{Songs/Rosita.tex}
\input{Songs/Vikingen.tex}
\input{Songs/Grävurtundran.tex}
\input{Songs/Fyllerian.tex}
\input{Songs/TillJägermeister.tex}
\input{Songs/Undulaten.tex}
\input{Songs/Härjarvisan.tex}
\input{Songs/Fiskebåt.tex}
\input{Songs/Varnöjdmedalltsombarenger.tex}
\input{Songs/LilleOlle.tex}
\input{Songs/Jumerviärtillsammans.tex}
\input{Songs/Fadderdinärskit.tex}
\input{Songs/BonkaBonka.tex}
\input{Songs/Jesuslever.tex}
