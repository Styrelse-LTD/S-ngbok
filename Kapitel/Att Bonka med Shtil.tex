...
Från första dagen tills n0lleperiodens slut och dygnet runt ska en lila tygslips vara knuten runt halsen (tyg, papper innebär ett helgerån).
på slipsen skall finnas.\\
\begin{tabular}{p{\textwidth}}
    $\cdot$ n0llans namn\\
    $\cdot$ Texten "DAT Ø"\\
    $\cdot$ Ett H eller V ifall n0llan är höger eller vänsterhänt\\
    $\cdot$ Ett schema att kryssa av n0lleaktiviteter i, 24 rutor. Samt en specialruta märkt Ø, för avslutat n0lleuppdrag\\
